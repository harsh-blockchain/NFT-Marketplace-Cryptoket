...
const ButtonGroup = ({ setActive, router }) => {
  ...
  return account ? (
    <Button
      classStyles="mx-2 rounded-xl hover:scale-105 transform ease-in-out duration-300"
      btnName="Create"
      handleClick={() => {
        setActive("");
  ...
  return (
    <nav className="flexBetween w-full fixed z-10 p-4 flex-row border-b dark:bg-nft-dark bg-white dark:border-nft-black-1 border-nft-gray-1">
      <div className="flex flex-1 flex-row justify-start">
        <Link href="/">
          <div
            className="flex items-center md:hidden cursor-pointer space-x-2"
            onClick={() => {}}
          >
            <Image
              src={images.logo02}
      ...
      <div className="flex flex-row flex-initial justify-end">
        <div className="flex items-center mr-2">
          ...
          <label
            htmlFor="checkbox"
            className="flexBetween w-10 h-5 bg-black rounded-2xl p-1 relative label cursor-pointer"
          >
